...
File ../schedule/if2026-schedule.ods is the schedule file for "IndiaFOSS 2026" conference.
Each session title in that file maps to an ID, which can be found by looking up the title
in ../schedule/cfp-all.csv. The actual proposal for each session is at
https://fossunited.org/c/indiafoss/2026/cfp/<ID>
